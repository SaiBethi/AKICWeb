  ...
  return (
    <div className="select-none max-w-md mx-auto mt-20 p-6 bg-white shadow-md rounded">
      ...
      <input
        ...
        className="select-none w-full border px-4 py-2 rounded mb-4 text-black"
      />
      <button
        onClick={handleLogin}
        className="select-none w-full bg-purple-700 text-white py-2 rounded hover:bg-purple-800"
      >
        Access Portal
      </button>
    </div>
